...
<head>
    ...
    <title>Dashboard | ConquistadoresClub</title>

    <link href="/backend/css/bootstrap.min.css" rel="stylesheet">
    <link href="/backend/font-awesome/css/font-awesome.css" rel="stylesheet">

    <!-- Morris -->
    <link href="/backend/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
    ...
    <!--DropZone-->
    <link href="/backend/css/plugins/dropzone/basic.css" rel="stylesheet">
...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            setTimeout(function() {
                $.gritter.add({
                    title: 'Bienvenido al administrador de ConquistadoresClub.CL!!! ',
                    text: 'Navega por el menu lateral, para que conozcas todas las opciones del sistema :-)',
                    time: 10000
                });
            }, 2000);
